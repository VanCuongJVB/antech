...
const Featured = () => {
  ...
  return (
    <section className="relative bg-deepSlate dark:bg-darkmode  after:absolute after:w-1/4 after:h-1/4 ]  after:top-72 after:right-0 after:bg-no-repeat" id="Featured">
